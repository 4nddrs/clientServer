...
cred = credentials.Certificate("clientserver-88fff-firebase-adminsdk-fbsvc-cd72f77cbd.json")  # Reemplaza con tu JSON de Firebase
...
class FirebaseApp(ctk.CTk):
    def __init__(self):
        ...
        self.frame.grid(row=1, column=0, sticky="nsew", padx=20, pady=10)

        # 🔹 Hacer la interfaz más flexible con grid
    ...
    def obtener_datos(self):
        ...
        for cliente in clientes_ref:
            ...
            frame_cliente.grid(sticky="ew", padx=10, pady=5)
            ...
            progress.grid(row=0, column=1, padx=10, pady=5)
            ...
            label_total.grid(row=0, column=2, padx=10, sticky="e")
